...
namespace Discuzit.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            var result = await SignInManager.PasswordSignInAsync(user.UserName?? "user", model.Password, model.RememberMe, shouldLockout: false);
            switch (result)
            {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await roleManager.CreateAsync(new IdentityRole(UserRoles.IsUser));
                    await UserManager.AddToRoleAsync(user.Id, UserRoles.IsUser);
